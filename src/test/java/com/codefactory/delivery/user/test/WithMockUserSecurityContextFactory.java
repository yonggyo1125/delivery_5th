package com.codefactory.delivery.user.test;

import com.codefactory.delivery.user.infrastructure.keycloak.KeycloakClientRoleConverter;
...
public class WithMockUserSecurityContextFactory implements WithSecurityContextFactory<MockUser> {
    ...
    public SecurityContext createSecurityContext(MockUser anno) {
        ...
        JwtAuthenticationToken authentication = new JwtAuthenticationToken(jwt, authorities, anno.username()); // JWT 전용 Authentication 구현체 만들기
